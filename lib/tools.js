...
export const legalPages = {
  ...
  blog: {
    title: "Creator Blog",
    description: "Creator guides for YouTube downloading, Shorts workflows, thumbnails, metadata and video optimization.",
    sections: [
      ["Coming soon", "Guides for YouTube video downloader workflows, Shorts downloads, thumbnails, titles, tags and creator productivity will be published here."],
      ["Editorial focus", "Articles will focus on practical, legal and creator-friendly usage of public video tools."]
    ]
  }
};
